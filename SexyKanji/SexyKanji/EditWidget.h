...
protected:
	virtual void			ProcessKey(EKeyboardLayout theKey, SexyChar theChar);
	SexyString&				GetDisplayString();
	virtual void			HiliteWord();
	void					UpdateCaretPos();

public:
	virtual void			SetFont(SexyFont* theFont, SexyFont* theWidthCheckFont = NULL);
	...
	void					AddWidthCheckFont(SexyFont *theFont, int theMaxPixels = -1); // defaults to mMaxPixels
