...
public:
	ListWidget(int theId, SexyFont *theFont, ListListener *theListListener);
	virtual ~ListWidget();
	...
	virtual void				SetColor(const SexyString& theLine, const SexyColor& theColor);
	virtual void				SetColor(int theIdx, const SexyColor& theColor);
	virtual void				SetLineColor(int theIdx, const SexyColor& theColor);	
