...
namespace Sexy
{
	...
	// In this demo, we're going to do some more advanced things like handle the 
	// two cases where Board is added and removed from the WidgetManager.
	class WidgetManager;

	class Board : public Widget, public ButtonListener, public EditListener, 
		public CheckboxListener, public ListListener
	{
	private:
		GameApp*			mApp;
	...
	public:
		...
		//	an edit widget.
		//////////////////////////////////////////////////////////////////////////
		void EditWidgetText(int theId, const SexyString& theString);
		...
		//////////////////////////////////////////////////////////////////////////
		bool AllowChar(int theId, SexyChar theChar);
