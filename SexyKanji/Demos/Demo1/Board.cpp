...
#include "SexyPoint.h" // SexyKanji Note: Point has been changed to SexyPoint.
...
void Board::Draw(Graphics* g)
{
	...
	g->SetColor(SexyColor(255, 128, 64));	// some ugly orangish color
	...
	g->SetColor(SexyColor(255, 0, 0));	// red

	// Parameter order is X1, Y1, X2, Y2
	g->DrawLine(0, 0, 200, 150);

	g->SetColor(SexyColor(0, 255, 0));	// green
	g->DrawLine(mWidth, 0, mWidth - 200, 150);

	g->SetColor(SexyColor(0, 0, 255));	// blue
	g->DrawLine(0, mHeight, 200, mHeight - 150);

	g->SetColor(SexyColor(255, 255, 255));	// white
	...
	// fill in the center. 
	g->SetColor(SexyColor(255, 0, 255));	// purple
	...
	SexyPoint trianglePoints[3];
	trianglePoints[0] = SexyPoint(30, 30);
	trianglePoints[1] = SexyPoint(30, 60);
	trianglePoints[2] = SexyPoint(60, 45);
	g->SetColor(SexyColor(255, 255, 0));	// yellow
	g->PolyFill(trianglePoints, 3);

	// And how about a pentagram as well?
	g->SetColor(SexyColor(0, 255, 255));	// cyan	
	SexyPoint pentaPoints[14];
	pentaPoints[0] = SexyPoint(200, 0);
	pentaPoints[1] = SexyPoint(150, 40);
	pentaPoints[2] = SexyPoint(150, 80);
	pentaPoints[3] = SexyPoint(250, 80);
	pentaPoints[4] = SexyPoint(250, 40);
